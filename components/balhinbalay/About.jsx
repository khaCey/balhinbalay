...
export default function About(){
  ...
  return <div className="narrow about-page">
    ...
    <div className="panel">
      ...
      <p>This preview currently uses sample listings and illustrative photos. Prices, availability, locations and Lister details have not been verified as real listings. No real accounts, messages or listing submissions are available.</p>
